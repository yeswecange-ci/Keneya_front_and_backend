...
@section('content')
 <!-- header--index -->
    <section class="header-section">
        <div class="slide active" style="background-image: url('{{asset('images/24.jpg')}}');">
    ...
    <section class="domains-activities" id="next-section">
        <div class="container-lg">
            <div class="section--title  wow fadeInRight">
                <h2>Domaines thématiques en santé publique</h2>
            </div>
            <div class="part-flex">
                <!-- left -->
                <div class="part-flex__left">
                    <img src="{{asset('images/15.jpg')}}" alt="kids">
                </div>
                ...
                <div class="part-flex__right">
                    ...
                    <div class="knumb--elts my-5">
                        <div class="knumb--elts__elt  wow fadeInLeft">
                            <img src="{{asset('images/16.png')}}" alt="img">
                            <div>
                                <h1> Santé reproductive, santé des mères, des nouveau-nés,
                                    des enfants et des adolescents ;</h1>
                            </div>
                        </div>
                        ...
                        <div class="knumb--elts__elt  wow fadeInLeft">
                            <img src="{{asset('images/17.png')}}" alt="img">
                            <div>
                                <h1> Maladies transmissibles</h1>
                                <p>VIH/sida, tuberculose, paludisme, hépatites, maladies infectieuses émergentes ;</p>
                            </div>
                        </div>
                        ...
                        <div class="knumb--elts__elt  wow fadeInLeft">
                            <img src="{{asset('images/18.png')}}" alt="img">
                            <div>
                                <h1> Maladies non transmissibles</h1>
                                <p>Diabète, maladies cardiovasculaires, santé mentale - addictions, cancers,
                                    traumatismes liés aux accidents de la route ;</p>
                            </div>
                        </div>
                        ...
                        <div class="knumb--elts__elt  wow fadeInLeft">
                            <img src="{{asset('images/19.png')}}" alt="img">
                            <div>
                                <h1> Sécurité sanitaire, santé-environnement et changement climatique</h1>
                                <p>Approche One Health et règlement sanitaire international ; préparation aux épidémies
                                    et réponse aux catastrophes ; résistance microbienne aux antibiotiques ; prévention
                                    et contrôle des infections ;</p>
                            </div>
                        </div>
                        ...
                        <div class="knumb--elts__elt  wow fadeInLeft">
                            <img src="{{asset('images/20.png')}}" alt="img">
                            <div>
                                <h1>Gouvernance et financement de la santé</h1>
                                <p>Couverture sanitaire universelle et mutualité sociale, micro-assurance privée ;
                                    développement des prestations de services ; développement des ressources humaines en
                                    santé ; développement des systèmes d'information sanitaire ; gestion des
                                    approvisionnements et des stocks de produits de santé, vaccins et technologies (GAS,
                                    AQ, laboratoires).</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card-offers">
                                    <div class="card-image-offer" style="background: url('{{asset('images/12.jpg')}}');">
                                        <!-- <img src="" alt="Image santé" class="card-img" > -->
                                    </div>
                                    <div class="card-content-offer">
                                        <small>01</small>
                                        <h3>Conseil stratégique, analyses, diagnostics<br>et revues en santé et
                                            protection sociale</h3>
                                        <ul>
                                            <li>Diagnostic et renforcement des systèmes de santé et protection sociale
                                            </li>
                                            <li>Élaboration, revue et évaluation de politiques et stratégies ; plans
                                                opérationnels et de
                                                suivi-évaluation</li>
                                            <li>Développement d’approches multi-maladies intégrées</li>
                                            <li>Développement de systèmes de santé communautaires efficaces</li>
                                        </ul>
                                    </div>
                                 </div>
                            </div>
    ...
    <section class="domain-map">
        <div class="container-lg">
            <div class="row  wow fadeInLeft">
                <div class="col-md-6 ">
                    <div class="section--title">
                        <h2>Couverture <br> géographique</h2>
                        <p>Lorem ipsum dolor sit amet consectetur. Eget at lacus quis pretium vitae ac non varius nec.
                            Feugiat praesent facilisi neque sollicitudin amet. Massa scelerisque pellentesque
                            condimentum .</p>
                    </div>
                </div>
                    ...
                    <div class="domain-map__map" id="map">
                        <div class="domain-map__map--image">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap"
                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 815 615">
                                <g>
                                    <path id="AO" title="Angola" class="land"
                                    ...
                                    <path id="BF" title="Burkina Faso" class="land"
                                    ...
                                    <path id="BI" title="Burundi" class="land"
                                    ...
                                    <path id="BJ" title="Benin" class="land"
                                    ...
                                    <path id="BW" title="Botswana" class="land"
                                    ...
                                    <path id="CD" title="Democratic Republic of Congo" class="land"
                                    ...
                                    <path id="CF" title="Central African Republic" class="land"
                                    ...
                                    <path id="CG" title="Republic of Congo" class="land"
                                    ...
                                    <path id="CI" title="Côte d'Ivoire" class="land"
                                    ...
                                    <path id="CM" title="Cameroon" class="land"
                                    ...
                                    <path id="DJ" title="Djibouti" class="land"
                                    ...
                                    <path id="DZ" title="Algeria" class="land"
                                    ...
                                    <path id="EG" title="Egypt" class="land"
                                    ...
                                    <path id="ER" title="Eritrea" class="land"
                                    ...
                                    <path id="ET" title="Ethiopia" class="land"
                                    ...
                                    <path id="GA" title="Gabon" class="land"
                                    ...
                                    <path id="GN" title="Guinea" class="land"
                                    ...
                                    <path id="KE" title="Kenya" class="land"
                                    ...
                                    <path id="LY" title="Libya" class="land"
                                    ...
                                    <path id="MA" title="Morocco" class="land"
                                    ...
                                    <path id="MG" title="Madagascar" class="land"
                                    ...
                                    <path id="ML" title="Mali" class="land"
                                    ...
                                    <path id="MR" title="Mauritania" class="land"
                                    ...
                                    <path id="MW" title="Malawi" class="land"
                                    ...
                                    <path id="MZ" title="Mozambique" class="land"
                                    ...
                                    <path id="NA" title="Namibia" class="land"
                                    ...
                                    <path id="NE" title="Niger" class="land"
                                    ...
                                    <path id="NG" title="Nigeria" class="land"
                                    ...
                                    <path id="RW" title="Rwanda" class="land"
                                    ...
                                    <path id="SD" title="Sudan" class="land"
                                    ...
                                    <path id="SL" title="Sierra Leone" class="land"
                                    ...
                                    <path id="SN" title="Senegal" class="land"
                                    ...
                                    <path id="SO" title="Somalia" class="land"
                                    ...
                                    <path id="SS" title="South Sudan" class="land"
                                    ...
                                    <path id="SZ" title="Swaziland" class="land"
                                    ...
                                    <path id="TD" title="Chad" class="land"
                                    ...
                                    <path id="TG" title="Togo" class="land"
                                    ...
                                    <path id="UG" title="Uganda" class="land"
                                    ...
                                    <path id="ZA" title="South Africa" class="land"
                                    ...
                                    <path id="ZM" title="Zambia" class="land"
                                    ...
                                    <path id="ZW" title="Zimbabwe" class="land"
    ...
    <section class="temoignages">
        <div class="container-lg">
            ...
            <h2>Études de cas/témoignages</h2>
            </div>
