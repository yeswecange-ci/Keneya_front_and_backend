        ...
        <div class="container-lg">
            ...
            <div class="part-flex">
                ...
                <div class="part-flex__left">
                    <img src="{{asset('images/10.jpg')}}" alt="kids">
                </div>

                <!-- right -->
                <div class="part-flex__right">

                    <p class="wow fadeInRight">Créé en 2012 sous l’impulsion du Dr. Jean-Baptiste Guiard-Schmid, <strong>KENAYA Impact</strong>
                        (anciennement
    ...
    <section>
        <div class="container-lg">
             <div class="part-flex">
                 <!-- left -->
                 <div class="part-flex__left">
                     <img src="{{asset('images/11.jpg')}}" alt="kids">
                 </div>
