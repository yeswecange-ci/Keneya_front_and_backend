            ...
            <form action="{{ route('activities.store-country') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="country_code" class="form-input" required maxlength="2"
                            placeholder="Ex: BF, CI, SN">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="color" name="color" class="h-10 w-20 p-1 rounded border border-gray-300"
                                value="#FFD700">
                            <span class="text-sm text-gray-500">Couleur par défaut: Jaune (#FFD700)</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
            ...
            <form id="editCountryForm" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        <label class="form-label">Code pays (ISO 2) *</label>
                        <input type="text" name="country_code" id="edit_country_code" class="form-input" required
                            maxlength="2">
                    ...
                    <div class="form-group">
                        <label class="form-label">Couleur sur la carte</label>
                        <div class="flex items-center space-x-2">
                            <input type="color" name="color" id="edit_country_color"
                                class="h-10 w-20 p-1 rounded border border-gray-300">
                            <span class="text-sm text-gray-500">Couleur actuelle</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    <button type="button" class="btn-secondary"
                        @click="countryModal = false; editMode = false">Annuler</button>
    ...
    window.editCountry = function (id) {
        fetch(`/dashboard/activities/countries/${id}/edit`)
            ...
            .then(country => {
                ...
                document.getElementById('edit_country_color').value = country.color || '#FFD700';
