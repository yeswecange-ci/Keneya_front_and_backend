...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="collapse" id="pageContentForm">
                    <form action="{{ route('activities.update-page-content') }}" method="POST"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (isset($pageContents['hero_image']) && $pageContents['hero_image'])
                                        <small class="text-muted">Image actuelle:
                                            {{ basename($pageContents['hero_image']) }}</small>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if (isset($pageContents['themes_section_image']) && $pageContents['themes_section_image'])
                                        <small class="text-muted">Image actuelle:
                                            {{ basename($pageContents['themes_section_image']) }}</small>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Lien bouton contact</label>
                                    <input type="url" name="contact_button_url" class="form-control"
                                        value="{{ $pageContents['contact_button_url'] ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Chiffres clés</h6>
                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addKeyNumberModal">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @forelse($keyNumbers as $keyNumber)
                                <tr>
                                    ...
                                    <td>{{ $keyNumber->activities_keynumber_value }}</td>
                                    <td>{{ $keyNumber->activities_keynumber_title }}</td>
                                    <td>{{ Str::limit($keyNumber->activities_keynumber_description, 50) }}</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm"
                                            onclick="editKeyNumber({{ json_encode($keyNumber) }})">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form method="POST"
                                            action="{{ route('activities.delete-keynumber', $keyNumber->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">Aucun chiffre clé trouvé</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            @forelse($themes as $theme)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm"
                                            onclick="editTheme({{ json_encode($theme) }})">
                                            <i class="fas fa-edit"></i>
                                        </button>
                            ...
                            @forelse($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST"
                                            action="{{ route('activities.delete-service', $service->id) }}"
                                            style="display: inline;" onsubmit="return confirm('Êtes-vous sûr ?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm">
                        ...
                        <tbody>
                            @forelse($testimonials as $testimonial)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm"
                                            onclick="editTestimonial({{ json_encode($testimonial) }})">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form method="POST"
                                            action="{{ route('activities.delete-testimonial', $testimonial->id) }}"
                                            style="display: inline;" onsubmit="return confirm('Êtes-vous sûr ?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('activities.store-theme') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Ordre</label>
                            <input type="number" name="activities_theme_order" class="form-control" value="0"
                                min="0">
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="editThemeForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Titre *</label>
                            <input type="text" name="activities_theme_title" id="edit_theme_title"
                        ...
                        <div class="form-group">
                            <label>Ordre</label>
                            <input type="number" name="activities_theme_order" id="edit_theme_order"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ordre</label>
                                    <input type="number" name="activities_service_order" class="form-control"
                                        value="0" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="service-features">
                                <div class="input-group mb-2">
                                    <input type="text" name="activities_service_features[]" class="form-control"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Titre *</label>
                                    <input type="text" name="activities_service_title" id="edit_service_title"
                                        class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ordre</label>
                                    <input type="number" name="activities_service_order" id="edit_service_order"
                                        class="form-control" value="0" min="0">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('activities.store-testimonial') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Lien</label>
                            <input type="url" name="activities_testimonial_link" class="form-control"
            ...
            <div class="modal-content">
                ...
                <form id="editTestimonialForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Titre *</label>
                            <input type="text" name="activities_testimonial_title" id="edit_testimonial_title"
                                class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <textarea name="activities_testimonial_description" id="edit_testimonial_description" class="form-control"
                                rows="4"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Image</label>
                        ...
                        <div class="form-group">
                            <label>Lien</label>
                            <input type="url" name="activities_testimonial_link" id="edit_testimonial_link"
...
@section('scripts')
    <script>
        ...
        function editTheme(theme) {
            ...
            document.getElementById('editThemeForm').action = '{{ route('activities.update-theme', ':id') }}'.replace(
                ':id', theme.id);
        ...
        function editService(service) {
            ...
            document.getElementById('editServiceForm').action = '{{ route('activities.update-service', ':id') }}'.replace(
                ':id', service.id);
    ...
    `;
        ...
        function editTestimonial(testimonial) {
            ...
            document.getElementById('edit_testimonial_description').value = testimonial
            ...
            document.getElementById('editTestimonialForm').action = '{{ route('activities.update-testimonial', ':id') }}'
                .replace(':id', testimonial.id);
        ...
        function editKeyNumber(keyNumber) {
            document.getElementById('edit_keynumber_title').value = keyNumber.activities_keynumber_title || '';
            document.getElementById('edit_keynumber_value').value = keyNumber.activities_keynumber_value || 0;
            document.getElementById('edit_keynumber_description').value = keyNumber.activities_keynumber_description || '';
            document.getElementById('edit_keynumber_order').value = keyNumber.activities_keynumber_order || 0;

            const iconInfo = document.getElementById('current_keynumber_icon');
            if (keyNumber.activities_keynumber_icon) {
                iconInfo.textContent = 'Icône actuelle: ' + keyNumber.activities_keynumber_icon.split('/').pop();
            } else {
                iconInfo.textContent = 'Aucune icône actuelle';
            }

            document.getElementById('editKeyNumberForm').action = '{{ route('activities.update-keynumber', ':id') }}'
                .replace(':id', keyNumber.id);
            $('#editKeyNumberModal').modal('show');
        }
    </script>
@endsection

<!-- Add Key Number Modal -->
<div class="modal fade" id="addKeyNumberModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ajouter un chiffre clé</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            </div>
            <form action="{{ route('activities.store-keynumber') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>Titre *</label>
                        <input type="text" name="activities_keynumber_title" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Valeur *</label>
                        <input type="number" name="activities_keynumber_value" class="form-control" required
                            min="0">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea name="activities_keynumber_description" class="form-control" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Icône</label>
                        <input type="file" name="activities_keynumber_icon" class="form-control-file">
                    </div>
                    <div class="form-group">
                        <label>Ordre</label>
                        <input type="number" name="activities_keynumber_order" class="form-control" value="0"
                            min="0">
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="editKeyNumberModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Modifier le chiffre clé</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                </button>
            </div>
            <form id="editKeyNumberForm" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
                        <label>Titre *</label>
                        <input type="text" name="activities_keynumber_title" id="edit_keynumber_title"
                            class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Valeur *</label>
                        <input type="number" name="activities_keynumber_value" id="edit_keynumber_value"
                            class="form-control" required min="0">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea name="activities_keynumber_description" id="edit_keynumber_description" class="form-control"
                            rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Icône</label>
                        <input type="file" name="activities_keynumber_icon" class="form-control-file">
                        <small id="current_keynumber_icon" class="text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label>Ordre</label>
                        <input type="number" name="activities_keynumber_order" id="edit_keynumber_order"
                            class="form-control" value="0" min="0">
                    </div>
                </div>
                <div class="modal-footer">
