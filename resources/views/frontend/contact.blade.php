...
@section('content')
    ...
    <section class="contact mgt">
        ...
        <div class="container-lg">
            <!-- formulaire -->
            <form class="form-candidature wow fadeInRight" action="{{ route('contact.application.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="date" name="availability_date" placeholder="Date de disponibilité" required>
    ...
    <section>
        <div class="container-lg wow fadeInLeft">
            ...
            <form class="form-candidature" action="{{ route('contact.quote.store') }}" method="POST">
                @csrf
                <input type="text" name="first_name" placeholder="Prénom" required>
                <input type="text" name="last_name" placeholder="Nom de famille" required>
                ...
                <textarea name="message" placeholder="Détaillez votre demande"></textarea>
