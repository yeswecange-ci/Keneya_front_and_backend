...
@section('content')
    ...
    <section class="contact">
        <div class="container-lg">
            ...
            <p class="wow fadeInRight">Merci  de remplir ce formulaire, afin de  postuler pour les positions disponibles dans
                notre cabinet.</p>
        </div>

        <!-- *** -->
        <img src="img/9.png" alt="img-people" class="img--contact wow fadeInLeft">
        ...
        <img src="img/9.png" alt="img-people" class="img--contact1 wow fadeInLeft">
