...
@section('title', 'Activités - Keneya')
@section('description', 'Découvrez nos différentes activités et programmes pour le développement communautaire.')

@section('content')
    <!-- header--index -->
    <section class="header-section">
        <div class="slide active" style="background-image: url('img/24.jpg');">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card-offers">
                                    <div class="card-image-offer" style="background: url('img/12.jpg');">
