...
class TeamController extends Controller
{
    ...
    {
        $teamMembers = TeamMemberDetail::orderBy('created_at', 'desc')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        if (isset($validated['is_leader']) && $validated['is_leader']) {
            TeamMemberDetail::where('is_leader', true)->update(['is_leader' => false]);
        }

        TeamMemberDetail::create($validated);
     ...
     */
    public function show(TeamMemberDetail $team)
    {
     ...
     */
    public function edit(TeamMemberDetail $team)
    {
     ...
     */
    public function update(Request $request, TeamMemberDetail $team)
    {
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'position' => 'required|string|max:255',
     ...
     */
    public function destroy(TeamMemberDetail $team)
    {
     ...
     */
    public function toggleLeader(TeamMemberDetail $team)
    {
        if (!$team->is_leader) {
